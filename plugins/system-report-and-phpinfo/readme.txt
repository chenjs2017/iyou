...
== Description ==
This plugin is a collection of tools useful that come in handy developing Wordpress plugins.

It can also be used to help third parties debug your website without granting them wp-admin access.
...
Every report can be exported to a text or html file.

== Installation ==
1. Upload the plugin files to the `/wp-content/plugins/plugin-name` directory, or install the plugin through the WordPress plugins screen directly.
1. Activate the plugin through the 'Plugins' screen in WordPress
1. Use the "Matt's Dev Tools" menu to access the features
