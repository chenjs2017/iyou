...
class MDT_Page_Git extends MDT_Page
{
	public function __construct()
	{
		$this->title 		= __('Git Repositories', 'matts-developer-tools');
		$this->description	= __('Simple list of all git tracked plugins and themes. Exports as a formatted .txt file.', 'matts-developer-tools');
	}
