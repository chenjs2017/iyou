...
class MDT_Page_Report extends MDT_Page
{
	public function __construct()
	{
		$this->title 		= __('System Report', 'matts-developer-tools');
		$this->description	= __('Overview your vital WordPress and environment data. Exports as formatted .txt file.', 'matts-developer-tools');
	}
	...
	public function page_data()
	{
		...
		$sessenb	= isset( $_SESSION ) ? __( 'Enabled', 'wordpress-system-report' ) : __( 'Disabled', 'wordpress-system-report' );
