...
function pointfinder_extrafunction_03_new(){
    register_widget( 'pf_recent_items_w_new' );
    register_widget( 'pf_featured_items_w_new' );
    register_widget( 'pf_search_items_w_new' );
    register_widget( 'pf_twitter_w_new' );
    register_widget( 'pf_featured_agents_w_new' );
};
...
class pf_search_items_w_new extends WP_Widget {
...
class pf_recent_items_w_new extends WP_Widget {
 ...
 **/
class pf_featured_items_w_new extends WP_Widget {
 ...
 **/
class pf_twitter_w_new extends WP_Widget {
 ...
 **/
class pf_featured_agents_w_new extends WP_Widget {
